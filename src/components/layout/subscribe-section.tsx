        ...
        <section className="bg-secondary-background flex items-end">
            <div className=" w-full  py-4 border-t border-black/20">
                <div className="container mx-auto flex flex-col items-center justify-around gap-4 text-center md:flex-row md:text-start">
                    ...
                    <span>
                        <h1 className="font-bold text-xl sm:text-2xl">Subcribe our Newsletter</h1>
                        <p className="text-sm opacity-60 font-light sm:text-base">Pellentesque eu nibh eget mauris congue mattis matti.</p>
                    </span>
                    <div className="flex w-full max-w-95 flex-col gap-2 sm:relative sm:block">
                        ...
                        <Button
                            variant="primary"
                            className="h-9 w-full rounded-full sm:absolute sm:end-0 sm:top-0 sm:w-28.75"
                        >
                            Subscribe
                        </Button>
                    </div>
